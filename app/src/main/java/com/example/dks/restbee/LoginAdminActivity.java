...
public class LoginAdminActivity extends AppCompatActivity {
    ...
    private void variable_in() {
        ...
        et_pass.addTextChangedListener(new LoginAdminActivity.MyTextWatcher(et_pass));
        et_mobile.addTextChangedListener(new LoginAdminActivity.MyTextWatcher(et_mobile));
        et_pass.addTextChangedListener(new LoginAdminActivity.MyTextWatcher(et_pass));
        et_name.addTextChangedListener(new LoginAdminActivity.MyTextWatcher(et_name));
    ...
    private void regnow(){
        ...
        Boolean reg = dbHelper.addAdmin(email,name,pass,"student");
    ...
    private boolean validateEmail() {
        if (et_email.getText().toString().length() != 12) {
            layout_email.setError("Invalid Enrollment No.");
